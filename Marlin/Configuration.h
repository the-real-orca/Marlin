...
#define PID_MAX 132 // Limits current to nozzle while PID is active (see PID_FUNCTIONAL_RANGE below); 255=full current
...
//#define DEBUG_LEVELING_FEATURE
  ...
  // TODO #define UBL_SAVE_ACTIVE_ON_M500   // Save the currently active mesh in the current slot on M500
...
#ifdef MANUAL_X_HOME_OFF
  #if (X_HOME_DIR > 0)
    #define MANUAL_X_HOME_POS (X_MAX_POS + MANUAL_X_HOME_OFF)
  #else
    #define MANUAL_X_HOME_POS (X_MIN_POS + MANUAL_X_HOME_OFF)
  #endif
#endif  

#ifdef MANUAL_Y_HOME_OFF
  #if (Y_HOME_DIR > 0)
    #define MANUAL_Y_HOME_POS (Y_MAX_POS + MANUAL_Y_HOME_OFF)
  #else
    #define MANUAL_Y_HOME_POS (Y_MIN_POS + MANUAL_Y_HOME_OFF)
  #endif
#endif  

#ifdef MANUAL_Z_HOME_OFF
  #if (Z_HOME_DIR > 0)
    #define MANUAL_Z_HOME_POS (Z_MAX_POS + MANUAL_Z_HOME_OFF)
  #else
    #define MANUAL_Z_HOME_POS (Z_MIN_POS + MANUAL_Z_HOME_OFF)
  #endif
#endif
