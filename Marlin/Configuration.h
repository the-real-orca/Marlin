...
#define STRING_SPLASH_LINE2 "ION i3"         // will be shown during bootup in line 2
...
////////////////////// TODO
#define FAN_PIN 4   // part cooling fan
#define FAN1_PIN 5

/*
 Chamber Extension

 chamber temprature sensor 10k thermistor @ A3

 Plug | Color         | Signal (RAMPS Pin)
 -----|---------------|-------
   8	| purple    		| #1 (D65 / A11) - Door
  11	| white	        | #2 (D44 / PWM)
   7	| blue	    		| #3 (D66 / A12)
   6	| green	    		| #4 (D42)
   4	| orange		    | #5 (D40) - Chamber Heater
  13	| light-green	  | #6 (D64 / A10) - Chamber Fan
   3	| red	      		| +5V
  12	| pink			    | +5V
   1	| black		      | GND (5V)
  14	| black-white	  | GND (5V)
   5	| yellow		    | +12V
   2	| brown     	  | +12V
  15	| brown-white   | +12V
  10	| gray		    	| GND (12V)
...
#define USE_ZMAX_PLUG // used as probe pin
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 100.22, 100.22, 399.8, 101.0} // 1/16 steps
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3[, E4[, E5]]]]]
 */
#define DEFAULT_MAX_ACCELERATION      { 4000, 4000, 100, 3000 }
...
#define DELAY_BEFORE_PROBING 750  // (ms) To prevent vibrations from triggering piezo sensors
...
//  #define MIN_SOFTWARE_ENDSTOP_Z  // disabled for auto-leveling
#endif
